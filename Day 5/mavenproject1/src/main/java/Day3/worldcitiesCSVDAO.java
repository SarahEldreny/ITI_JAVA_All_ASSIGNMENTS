...
public class worldcitiesCSVDAO {
    ...
    public Worldcities createWorldcities(String[] metadata) {
        Worldcities worldcitiesObj = new Worldcities(metadata[0],metadata[1],metadata[5],Double.parseDouble(metadata[2]),Double.parseDouble(metadata[4]),Double.parseDouble(metadata[5]));
